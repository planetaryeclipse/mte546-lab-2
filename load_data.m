function [t,ir_leftside_right,ir_leftside_left,ir_topside_right, ...
    ir_topside_left,thermo_tr,thermo_br,thermo_bl,thermo_tl] = load_data(file)
...
ir_leftside_right = ir_med_v_to_dist(data(:,1)) / 10;
ir_leftside_left = ir_short_v_to_dist(data(:,2)) / 10;
ir_topside_right = ir_long_v_to_dist(data(:,3)) / 10;
ir_topside_left = ir_long_v_to_dist(data(:,4)) / 10;
